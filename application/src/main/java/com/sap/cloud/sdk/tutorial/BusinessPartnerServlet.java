...
public class BusinessPartnerServlet extends HttpServlet {
    ...
    // private static final String DESTINATION = "S4H_CC_200";
    private static final String DESTINATION = "S4H_CC";
    private final ErpHttpDestination destination = DestinationAccessor.getDestination(DESTINATION).asHttp().decorate(DefaultErpHttpDestination::new);
